...
const Assistant: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Sasa! I am Bihh, your assistant. Unaeza niuliza chochote kuhusu gari zetu ama safari yako.', timestamp: Date.now() }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const responseText = await sendMessageToGemini(history, userMsg.text, vehicles);
        ...
        <div className="bg-[#F5F2EB] rounded-none shadow-2xl shadow-[#2C2A26]/10 w-[90vw] sm:w-[380px] h-[550px] mb-6 flex flex-col overflow-hidden border border-[#D6D1C7] animate-slide-up-fade">
          ...
          <div className="bg-[#EBE7DE] p-5 border-b border-[#D6D1C7] flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <span className="font-serif italic text-[#2C2A26] text-lg">Bihh Assistant</span>
            </div>
