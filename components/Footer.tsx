      ...
      <div className="max-w-[1800px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-4">
          <div className="flex items-center gap-3 mb-6">
            ...
            />
            <h4 className="text-2xl font-serif text-[#2C2A26]">Bihh</h4>
          </div>
          <p className="max-w-xs font-light leading-relaxed">
            Moving Kenya differently. From the city to the coast, we provide the journey you deserve.
          </p>
        </div>

        <div className="md:col-span-2">
          <h4 className="font-medium text-[#2C2A26] mb-6 tracking-wide text-sm uppercase">Fleet</h4>
          <ul className="space-y-4 font-light">
            <li><a href="#products" onClick={(e) => onLinkClick(e, 'products')} className="hover:text-[#2C2A26] transition-colors underline-offset-4 hover:underline">All Vehicles</a></li>
            <li><a href="#products" onClick={(e) => onLinkClick(e, 'products')} className="hover:text-[#2C2A26] transition-colors underline-offset-4 hover:underline">Matatus</a></li>
            <li><a href="#products" onClick={(e) => onLinkClick(e, 'products')} className="hover:text-[#2C2A26] transition-colors underline-offset-4 hover:underline">Safari</a></li>
            <li><a href="#products" onClick={(e) => onLinkClick(e, 'products')} className="hover:text-[#2C2A26] transition-colors underline-offset-4 hover:underline">Luxury</a></li>
          </ul>
        </div>
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-4 font-light">
            ...
            <li><a href="#journal" onClick={(e) => onLinkClick(e, 'journal')} className="hover:text-[#2C2A26] transition-colors underline-offset-4 hover:underline">Roadtrips</a></li>
          </ul>
        </div>
