      ...
      >
        <div className="max-w-[1800px] mx-auto px-8 flex items-center justify-between">
          ...
          <a
            ...
            className="z-50 relative transition-opacity duration-500 hover:opacity-80"
          >
            <img
              src="/assets/logo.jpg"
              alt="Bihh Logo"
          ...
          <div className={`hidden md:flex items-center gap-12 text-sm font-medium tracking-widest uppercase transition-colors duration-500 ${textColorClass}`}>
            <a href="#products" onClick={(e) => handleLinkClick(e, 'products')} className="hover:opacity-60 transition-opacity">Cars</a>
            <a href="#about" onClick={(e) => handleLinkClick(e, 'about')} className="hover:opacity-60 transition-opacity">About</a>
            <a href="#journal" onClick={(e) => handleLinkClick(e, 'journal')} className="hover:opacity-60 transition-opacity">Roadtrips</a>
          </div>
